                        ...
                        <div class="col-xl-12 ">
                            <div class="footer-copy-right text-center">
                                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                  Copyright &copy;{{ fullYear }} All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
...
export default {
    ...
    created: function() {
        ...
        ckeditor.setAttribute('src',"./assets/js/main.js");
        ...
        x.forEach(element => {
            let ckeditor = document.createElement('script');
            ckeditor.setAttribute('src', element);
            document.getElementById('scriptContainer').appendChild(ckeditor);
        });
